...
public class ChooseProf2 extends JFrame {
    ...
    private ShowStudentiProf showStudentiProf = new ShowStudentiProf();
	...
	public ChooseProf2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
                ...
                new ShowStudentiProf(nume).setVisible(true);                
			}
		});
		btnNewButton.setFont(new Font("Tw Cen MT Condensed", Font.BOLD, 20));
		btnNewButton.setBounds(162, 253, 158, 44);
